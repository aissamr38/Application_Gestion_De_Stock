 ...
 * @author user
 */
public class PrinEmployer extends javax.swing.JFrame {

    /**
     * Creates new form PrinEmployer
     */
    public PrinEmployer() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton4.setBounds(130, 210, 101, 39);
        ...
        jButton2.setBounds(30, 130, 107, 39);
        ...
        jButton3.setBounds(237, 130, 100, 40);

        jLabel1.setFont(new java.awt.Font("Times New Roman", 3, 48)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(51, 153, 255));
        jLabel1.setText("Espace Employer");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(4, 10, 370, 56);
...
this.dispose();// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrinEmployer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrinEmployer().setVisible(true);
            }
        });
    }
